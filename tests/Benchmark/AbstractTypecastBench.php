...
class AbstractTypecastBench
{
    ...
    public function before(): void
    {
        ...
        $this->string->dbTypecast = SchemaInterface::PHP_TYPE_STRING;
        $this->string->phpTypecast = SchemaInterface::PHP_TYPE_STRING;
        ...
        $this->integer->dbTypecast = SchemaInterface::PHP_TYPE_INTEGER;
        $this->integer->phpTypecast = SchemaInterface::PHP_TYPE_INTEGER;
        ...
        $this->double->dbTypecast = SchemaInterface::PHP_TYPE_DOUBLE;
        $this->double->phpTypecast = SchemaInterface::PHP_TYPE_DOUBLE;
        ...
        $this->boolean->dbTypecast = SchemaInterface::PHP_TYPE_BOOLEAN;
        $this->boolean->phpTypecast = SchemaInterface::PHP_TYPE_BOOLEAN;
        ...
        $this->binary->dbTypecast = 'dbBinary';
        $this->binary->phpTypecast = SchemaInterface::PHP_TYPE_STRING;
        ...
        $this->json->dbTypecast = 'dbJson';
        $this->json->phpTypecast = 'phpJson';

        $this->bit = new ColumnSchema('bit');
        $this->bit->type(Schema::TYPE_BIT);
        $this->bit->dbType('bit');
        $this->bit->phpType(SchemaInterface::PHP_TYPE_INTEGER);
        $this->bit->dbTypecast = 'dbBit';
        $this->bit->phpTypecast = 'phpBit';
        ...
        $this->intArray->dbTypecast = SchemaInterface::PHP_TYPE_INTEGER;
        $this->intArray->phpTypecast = SchemaInterface::PHP_TYPE_INTEGER;
    }
}
